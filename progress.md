...
сделать её одним заходом уже после merge с апстримом (не тратить время на
двойную проверку до и после). Ожидаю уточнения: начинать ли сейчас сам
merge, или закрыть сессию по плагинной архитектуре здесь.
